...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      "group flex w-full gap-2 font-mono",
      from === "user"
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "flex flex-col gap-2 overflow-hidden rounded-lg px-4 py-3 text-foreground md:text-sm text-xs font-mono",
...
export const ThinkingMessage = ({ children, ...props }: HTMLAttributes<HTMLDivElement>) => (
  <div {...props} className="font-mono">Thinking...</div>
);
