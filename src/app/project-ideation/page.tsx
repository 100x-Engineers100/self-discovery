...
const modules: ModuleContext[] = [
  {
    ...
    learningOutcomes: [
      ...
      "Grasp the ethical considerations in AI.",
    ],
    topicsCovered: [
      "What is AI?",
      "History of AI",
      "AI vs Machine Learning vs Deep Learning",
      "Applications of AI (e.g., NLP, Computer Vision)",
      "Ethical AI principles",
    ],
    balanceType: "ideation_balance_1",
  },
  {
    name: "Module 2: Machine Learning Fundamentals",
    description: "Dive into the core concepts of Machine Learning.",
    learningOutcomes: [
  ...
  {
    name: "Module 3: Deep Learning Concepts",
    description: "Explore advanced topics in Deep Learning.",
    learningOutcomes: [
      "Understand the architecture of neural networks.",
      "Implement deep learning models using frameworks like TensorFlow/PyTorch.",
  ...
  {
    name: "Module 4: Natural Language Processing",
    description: "Understand how computers process human language.",
    learningOutcomes: [
      "Process and analyze textual data.",
      "Build NLP models for tasks like sentiment analysis and machine translation.",
        ...
        <div className="flex flex-col w-full h-screen p-4 overflow-hidden">
          ...
          {!selectedModule ? (
            ...
            <div className="w-full">
              ...
              <button
                className="mb-4 px-4 py-2 bg-[#ee593b] text-white rounded hover:bg-[#d44a2f]"
